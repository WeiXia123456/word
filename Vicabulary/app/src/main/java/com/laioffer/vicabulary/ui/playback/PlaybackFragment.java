...
public class PlaybackFragment extends Fragment implements ActionMode.Callback {
    ...
    final Handler mainHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 1) {
                binding.srtTxt.setText("" + msg.obj);
            }
        }
    };
    ...
    private void initExoplayer(String videoUrl, long time) {
        // create player
        ...
        player.addListener(new Player.EventListener() {
            ...
            public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
                ...
                // Jump to the savepoint
                if (player.getCurrentPosition() == 0 && time != 0 && firstTimeWatch) {
                    player.seekTo(time);
...
//    }
    ...
    private void initializeUI() {
        if (binding.srtTxt != null) {
            Log.d("show srt", "setText is not null");
            binding.srtTxt.setTextIsSelectable(true);
            //srtText.setCustomSelectionActionModeCallback (new SelectWordCallback());
            binding.srtTxt.setCustomSelectionActionModeCallback(this);
        }
    }
    ...
    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
        ...
        CharacterStyle cs;
        int start = binding.srtTxt.getSelectionStart();
        int end = binding.srtTxt.getSelectionEnd();
        SpannableStringBuilder ssb = new SpannableStringBuilder(binding.srtTxt.getText());
    ...
    private void getDefinition(Word word) {
        ...
        String url = dictionaryEntries(word.getWord());
        dR.execute(url);
    }
